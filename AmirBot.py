...
async def info(ctx, arg, *options):
    ...
    sprite = data["sprite"]["front_default"] # pokemon sprite
    official_image = data['sprite']['other']['official-artwork']['front_default'] # offical_art_work
    ...
    for option in options:
        if option.lower() == '____': # abilities
...
bot.run("MTAzMjc5NTAxMDM3NjE0NzA1NA.GejHBi.FOcawIaQA_0fE3TLyCeitJ8cFW9x1JhlwR1VKs")
